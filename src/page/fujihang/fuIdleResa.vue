 ...
 * @LastEditTime: 2020-08-04 10:40:49
 * @Description: 闲置转卖
--> 
  ...
  <div id="fuIdleResa">
    <div class="bgContant" v-show="showZM">
      ...
      <div class="tableWork">
        ...
        >
          ...
          <el-table-column prop="title" label="物品介绍" align="center"></el-table-column>
          <el-table-column prop="price" label="转卖价格" align="center"></el-table-column>
          ...
          <el-table-column prop="buystatus" label="转卖状态" align="center"></el-table-column>
    ...
    <div class="bgContant2" v-show="!showZM">
      <div class="noticeT">
        ...
        <el-button size="small" @click="showZM=true">返回</el-button>
      </div>
      <div class="list">
      ...
      >
        ...
        <span class="val">
          <el-input v-if="index!=1" v-model="item.val" :type="index==1||index==2||index==7?'textarea':''"></el-input>
