 ...
 * @LastEditTime: 2020-08-03 11:52:13
 * @Description: 商铺管理    
--> 
<template>
  <div id="fuShopMana">
    <div class="bgContant" v-show="showDoor">
      ...
      <div class="tableWork">
        ...
        >
          ...
          <el-table-column prop="roomId" label="商铺号" align="center"></el-table-column>
          <el-table-column prop="status" label="房屋状态" align="center"></el-table-column>
          <el-table-column prop="name" label="姓名" align="center"></el-table-column>
          <el-table-column prop="phone" label="电话" align="center"></el-table-column>
          <el-table-column prop="time" label="售出时间" align="center"></el-table-column>
          <el-table-column prop="num" label="绑定人数" align="center"></el-table-column>
