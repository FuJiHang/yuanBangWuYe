<!--
 * @Author: fujihang
 * @Date: 2020-07-22 17:23:56
 * @LastEditors: your name
 * @LastEditTime: 2020-07-22 17:30:43
 * @Description: 节日活动
--> 


<template>
  <div id="fuFestActivit">
    <template v-if="true">
    ...
    <template v-else>
      ...
      <div class="inputList">
        ...
        <textarea v-model="notice" placeholder="请输入新闻内容"></textarea>
      </div>
      <div class="imgList">
        <span class="name">活动配图</span>
        <span class="contant">
          <span class="add">+</span>
